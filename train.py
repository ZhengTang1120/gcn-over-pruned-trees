...
train_batch = DataLoader(opt['data_dir'] + '/train_ssl_100.json'.format(opt['curve']), opt['batch_size'], opt, vocab, opt['data_dir'] + '/mappings_train.txt', opt['data_dir'] + '/interval_train.txt', evaluation=False)
