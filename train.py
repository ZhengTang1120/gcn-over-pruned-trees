...
train_batch = DataLoader(opt['data_dir'] + '/train_ssl_100.json'.format(opt['curve']), opt['batch_size'], opt, vocab, opt['data_dir'] + '/mappings_train_ssl_100.txt'.format(opt['curve']), evaluation=False)
