...
ENTITY_TOKENS = ['[SUBJ-ORGANIZATION]', '[SUBJ-PERSON]', '[OBJ-CITY]', '[OBJ-CAUSE_OF_DEATH]', '[OBJ-DURATION]', '[OBJ-STATE_OR_PROVINCE]', '[OBJ-TITLE]', '[OBJ-CRIMINAL_CHARGE]', '[OBJ-COUNTRY]', '[OBJ-URL]', '[OBJ-RELIGION]', '[OBJ-MISC]', '[OBJ-NUMBER]', '[OBJ-IDEOLOGY]', '[OBJ-PERSON]', '[OBJ-LOCATION]', '[OBJ-NATIONALITY]', '[OBJ-DATE]', '[OBJ-ORGANIZATION]', '[OBJ-SEP]', '[SUBJ-SEP]']
